...
export default function ProfilePage() {
  ...
  const [userData, setUserData] = useState({
    username: 'driver_5839',
    displayName: 'Alex Johnson',
    email: 'alex.j@example.com',
    phone: '(404) 555-1234',
    bio: 'Frequent traveler on I-85. Always looking for reliable roadside assistance.',
    profileImage: '',
  ...
  const userAchievements = defaultAchievements.map((achievement, index) => ({
    ...achievement,
