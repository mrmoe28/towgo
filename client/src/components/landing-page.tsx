...
import { ReplitBadge } from '@/components/ui/share-card';
import { TestimonialCarousel, UserStatistics, sampleTestimonials } from '@/components/ui/social-proof';
import { AchievementBadge, defaultAchievements } from '@/components/ui/achievement';
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container px-4 mx-auto max-w-5xl">
          <div className="flex flex-col items-center text-center md:flex-row md:text-left md:justify-between md:items-start">
            <div className="md:max-w-xl mb-10 md:mb-0">
              ...
              {isFirstVisit && (
                <div className="mt-6 flex items-center justify-center md:justify-start animate-pulse-purple">
                  <Card className="bg-purple-50 border-purple-100 shadow-sm">
                    <CardContent className="p-4 flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-sm font-medium text-purple-800">First Search Bonus!</p>
                        <p className="text-xs text-purple-600">Complete your first search to earn Achievement points</p>
                      </div>
                    </CardContent>
                  </Card>
                </div>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-purple-50">
        <div className="container px-4 mx-auto max-w-5xl">
          <div className="text-center mb-12">
            <h2 className="mb-3 text-3xl font-bold text-gray-900">Earn Achievements</h2>
            <p className="mx-auto max-w-2xl text-gray-600">
              Complete actions to unlock badges and rewards as you use TowGo
            </p>
          </div>
          
          <Tabs defaultValue="achievements" className="w-full">
            <TabsList className="mx-auto w-full max-w-md grid grid-cols-2 mb-8">
              <TabsTrigger 
                value="achievements" 
