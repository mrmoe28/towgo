...
export default function MapView({ 
  ...
  // Initialize Google Maps API early on component mount
  useEffect(() => {
    let isMounted = true;
    
    // Start loading Google Maps API immediately
    // Since we already preloaded API in lib/maps.ts, this should be fast
