...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  apiRouter.get("/recommendations", async (req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error generating recommendations";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.get("/perplexity", async (req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Failed to perform AI search";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.get("/websearch", async (req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "An unexpected error occurred during web search";
      console.error(`API Error [${statusCode}]:`, error);
      res.setHeader('Content-Type', 'application/json');
      res.status(statusCode).json({
        error: true,
  ...
  apiRouter.post("/location-share", async (req: Request, res: Response) => {
    try {
      ...
      if (error instanceof ZodError) {
        ...
        const statusCode = error.status || 500;
        const message = error.message || "Failed to create location share";
        console.error(`API Error [${statusCode}]:`, error);
        res.status(statusCode).json({ 
          error: true,
          message,
  ...
  apiRouter.get("/location-share/:shareId", async (req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Failed to retrieve location share";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.delete("/location-share/:shareId", async (req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Failed to delete location share";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.get("/location-shares", async (_req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Failed to retrieve active location shares";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.get("/services", async (_req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error getting services";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.get("/services/:id", async (req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error getting service";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.post("/services", async (req: Request, res: Response) => {
    try {
      ...
      if (error instanceof ZodError) {
        ...
        const statusCode = error.status || 500;
        const message = error.message || "Error creating service";
        console.error(`API Error [${statusCode}]:`, error);
        res.status(statusCode).json({ 
          error: true,
          message,
  ...
  apiRouter.patch("/services/:id", async (req: Request, res: Response) => {
    try {
      ...
      if (error instanceof ZodError) {
        ...
        const statusCode = error.status || 500;
        const message = error.message || "Error updating service";
        console.error(`API Error [${statusCode}]:`, error);
        res.status(statusCode).json({ 
          error: true,
          message,
  ...
  apiRouter.get("/payments", async (_req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error getting payments";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.get("/payments/:id", async (req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error getting payment";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.get("/payment-status/:sessionId", async (req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error getting payment status";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.get("/subscription/plans", async (_req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error fetching subscription plans";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.post("/subscription/checkout", async (req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error creating subscription checkout";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.post("/subscription/trial", async (_req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error starting trial";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.get("/subscription/status", async (_req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error fetching subscription status";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
  ...
  apiRouter.get("/subscription/access", async (_req: Request, res: Response) => {
    try {
      ...
      const statusCode = error.status || 500;
      const message = error.message || "Error checking premium access";
      console.error(`API Error [${statusCode}]:`, error);
      res.status(statusCode).json({ 
        error: true,
        message,
